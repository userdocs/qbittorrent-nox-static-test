...
set_default_values() {
	...
	qbt_revision_url="${qbt_revision_url:-userdocs/qbittorrent-nox-static-test}" # The workflow will set this dynamically so that the urls are not hardcoded to a single repo
