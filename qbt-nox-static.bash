...
_set_module_urls() {
	...
	github_tag[openssl]="openssl-4.0.0-alpha1"
	...
	qbt_workflow_archive_url[openssl]="https://github.com/openssl/openssl/releases/download/openssl-4.0.0-alpha1/openssl-4.0.0-alpha1.tar.gz"
